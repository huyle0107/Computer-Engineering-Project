...
var RedisService = function () {
    ...
    var RedisService = _classThis = /** @class */ (function () {
        function RedisService_1(cacheManager) {
        ...
        RedisService_1.prototype.set = function (key, value, options) {
            return __awaiter(this, void 0, void 0, function () {
                var ttl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.cacheManager.set(key, value, { ttl: ttl })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        RedisService_1.prototype.del = function (key) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.cacheManager.del(key)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
